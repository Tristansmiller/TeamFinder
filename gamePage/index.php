...
<?php
	...
	$sql = "SELECT * FROM ad WHERE game = '".$game[0]['name']."'";
	$result = $conn->query($sql);
	...
	*/
	...
	if($adsFound==true){
		for($x=0;$x<sizeof($adArray);$x++){
			$sql = "SELECT gameTag FROM user INNER JOIN ad ON user.userID=ad.userID WHERE ad.userID = ".$adArray[$x]['userID'];
			$result = $conn->query($sql);		
			if($result->num_rows>0){
				while($row=$result->fetch_assoc()){
					$adArray[$x]['userID']=$row['gameTag'];	
				}
			}		
		}
	}
  ...
  <div class="pageBody">
    <div class="title">
        ...
        <div id="titleImgBox">
          ...
          <h1 id="gameName"><?php echo $game[0]['name'] ?></h1>
        </div>
    ...
    <div class="pageList" id="pageList">  
	  ...
	  <script src="test2.js" type="text/javascript" onload="populatePageList(adArray)"></script>
    </div>
  </div>
</body>
</html>
...
<body >
  <div class="side">
    ...
    <div class="currentUser" id="currentUserBox">
    </div>
  </div>
  <div class="pageBody" id="pageBody">
    <div class="title">
        ...
        <div class="modal fade" id="createModal" role="dialog">
                ...
                <div class="modal-body" style="padding:40px 50px;">
                  ...
                  <div class="listInfo">
                    <div class="form-group ad-desc-form">
                      ...
                      <input class="form-control ad-desc-input" size="50" id="adDesc" placeholder="Enter a description." size="50">
                    </div>
                  </div>
                </div>
                <div class="modal-footer">
          ...
          <div id="titleImgBox">
            <img id="gameImage" src="assets/test.png">
            <h1 id="gameName">[Title]</h1>
          </div>
        <div id="titleLoginBox">
        </div>
      </div>
    ...
    <div class="pageList" id="pageList">
      <script language="javascript" src="./test.js" onload="populatePageList(10);adjustPage();"></script>
      <script language="javascript" src="./testGame.js" onload="populatePageList(10);populateSideBar(15);loggedAs('USER1');"></script>
    </div>
  </div>
</body>
</html>
...
<body >
  ...
  <div class="pageBody" id="pageBody">
    ...
    <div class="pageList" id="pageList">
      <script language="javascript" src="./testGame.js" onload="populatePageList(10);populateSideBar(15);loggedAs('USER1');adjustPage();"></script>
    </div>
  </div>
</body>
</html>
>>>>>>> refs/remotes/origin/master:gamePage/index.html
